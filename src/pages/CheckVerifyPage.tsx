    ...
    return (
        <div className="min-h-screen flex items-center justify-center custom-radial-gradient">
            ...
            >
                ...
                <div className="text-[14px] text-white w-1/3 text-center">An email has been sent to {email}. It contains an activation link you must click to activate your account. </div>
