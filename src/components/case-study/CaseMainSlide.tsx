    ...
    <div>
      <div className="relative">
        <div className="relative overflow-hidden">
          <img
            className="sm:w-full w-[120%] max-w-none h-auto"
            src="/case-study/Polygon 3.svg"
          />
          <img
            className="absolute top-0 right-0 w-[90%]"
            src="/case-study/Group 2285.png"
          />
        </div>
      ...
      <div className="relative">
        <div className="absolute top-0 w-full flex items-end justify-end">
          <img
            className="md:mt-[-20%] mt-[-35%] w-[42%]"
            src="/case-study/Group 337.png"
          />
        </div>
        <div className="xl:mx-[161px] mx-[44px]">
          ...
          <div className="mt-[21px] md:max-w-[65%] max-w-none text-dark-gray 2xl:text-[20px] lg:text-[16px] text-[12px] max-w-[1026px] leading-[174%] tracking-[0.02em]">
            ...
            year. Its fresh, high-tech approach became an instant hit, carving
            out a strong presence in Singapore’s competitive events market.
          </div>
          ...
          <div className="mt-[21px] md:max-w-[65%] max-w-none text-dark-gray 2xl:text-[20px] lg:text-[16px] text-[12px] max-w-[1026px] leading-[174%] tracking-[0.02em]">
            By its second year, The Holograil doubled its bookings, reaching
            over 400 events. The lenticular photobooth became a must-have for
            weddings, corporate events, and more, solidifying its status as a
            market leader.
          </div>
        </div>
      </div>
